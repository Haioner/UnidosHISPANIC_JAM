...
public class LegendsManager : MonoBehaviour
{
	...
	[SerializeField] private int bookLimit = 5;
	...
	public void CalculateLegendDeaths(CharacterSO characterSO)
	{
		foreach (var legend in currentLegendsStats)
		{
			...
			{
				//50% souls
				float soulsCollected = legend.AcumulatedDeaths * 0.2f;
	...
	public bool ReachedBookLimit()
	{
		return currentLegendsStats.Count >= bookCount * bookLimit;
	}

	public bool HaveBookSpace(CharacterSO character)
	{
		int maxLegends = bookCount * bookLimit;
